...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper" id="main_content">
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="admin/posts/${post.getPid()}">
                            <div class="mb-3">
                                <label for="article-author" class="form-label">标题</label>
                                <input type="text" class="form-control" id="article-author" name="title"
                                       aria-describedby="emailHelp" required value="${post.getTitle()}">
                            </div>
                            <div class="mb-3">
                                <label for="article-description" class="form-label">描述</label>
                                <textarea class="form-control placeholder-control" id="article-description" name="description" placeholder="${post.getDescription()}"></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="formFile" class="form-label">选择你的markdown文件</label>
                                <textarea class="form-control placeholder-control" id="formFile" name="content" placeholder="${post.getContent()}"></textarea>
                            </div>
    ...
    <script>
        $(".placeholder-holder").click(function (){
